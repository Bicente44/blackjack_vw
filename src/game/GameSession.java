...
public class GameSession {
    ...
    public static List<HandManager> hands = new ArrayList<>();
    ...
    public static void gameStart() {
        ...
        // Dealer hidden card
        Card dealerHidden = HandManager.drawCard();
...
//		Split
    ...
    public static void dealerPlay() {
        ...
        while (dealerHand.getTotal() < 17) {
            Card draw = HandManager.drawCard();
