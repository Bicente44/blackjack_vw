...
public class HandManager {
    ...
    public static void playerPass(){
        ...
        for (int i = 1; i < numPlayers; i++) {
            Card c = HandManager.drawCard();
            GameSession.hands.get(i).addCard(c);
            System.out.println(GameSession.players.get(i).getPlayerName() + ": " + c);
        }
    }
    ...
    public static void checkBlackjack() {
        ...
        for (int i = 1; i < numPlayers; i++) {
            ...
            if (playerBJ) {
                System.out.println(GameSession.players.get(i).getPlayerName() + " has Blackjack and will stand.");
            }
        }
    }
